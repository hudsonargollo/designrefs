...
<head>
<meta charset="utf-8">
<title>${escapeHtml(domain)} - Brand Guide - Made with DesignRefs</title>
<meta name="author" content="DesignRefs">
<meta name="keywords" content="designrefs, brand guide, ${escapeHtml(domain)}">
<meta name="description" content="Brand guide for ${escapeHtml(domain)}, generated by DesignRefs">
<style>
  ${googleFontImport}
...
<div class="page cover">
  ...
  <div class="cover-meta">${escapeHtml(domain)}&nbsp;&nbsp;&middot;&nbsp;&nbsp;${date}${data.meta?.designrefsVersion ? `&nbsp;&nbsp;&middot;&nbsp;&nbsp;v${escapeHtml(data.meta.designrefsVersion)}` : ''}</div>
</div>
...
${(() => {
  ...
  const version = data.meta?.designrefsVersion;
  return `
<div class="page back-cover">
  ...
  <div class="back-attrib">
    Created with <strong>DESIGNREFS</strong>&nbsp;&nbsp;&middot;&nbsp;&nbsp;designrefs.com${version ? `&nbsp;&nbsp;&middot;&nbsp;&nbsp;v${escapeHtml(version)}` : ''}
  </div>
</div>`;
})()}
